...
<head>
	...
	<title>Slice of Heaven - About Us</title><!-- Bootstrap core CSS -->
...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item active px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="about.php">About Us (current)</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">About <strong>Slice of Heaven</strong></h2>
			<hr class="divider">
			<div class="row">
				<div class="col-lg-6"><img alt="" class="img-fluid mb-4 mb-lg-0" src="img/about.jpg"></div>
				<div class="col-lg-6">
					<?php foreach ($results as $row): ?>
					<p><?php echo $row["bio"] ?></p><?php endforeach; ?>
				</div>
			</div>
		</div>
	</div><!-- /.container -->
