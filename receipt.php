...
<head>
	...
	<link href="vendor/bootstrap/css/bootstrap.css" rel="stylesheet"><!-- Custom fonts for this template -->
...
<body>
	...
	<div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Your<br>
			<strong>Order Has Been Placed</strong></h2>
			<hr class="divider">
			<br>
			<div class="row">
				<div class="col-lg-4"></div>
				<div class="col-lg-4">
					<h3 class="text-center">Thank You For Chossing Us!</h3>
				</div>
			</div>
		</div>
	</div><!-- /.container -->
